...
<font color="white">
  ...
  <p  align="left" style="text-indent: 4em;"><b>New York Institute of Technology</b> is devoted to excellence in teaching, learning, and research, and to developing leaders in many disciplines who make a difference globally. The University, based in Manhattan, New York, has an enrollment of over 4,000 degree candidates, including undergraduate, graduate, and professional students. NSTUD has got more than 60,000 alumni around the country.</p>
  
  <p align="left" >We offer the following services: </p>
  <h4 align="left">Student: </h4>
  <p align="left"> NSTUD has been admitting students to its undergraduate programmes on the basis of marks obtained by them in the Joint Entrance Examination (GRE) Courses on offer are:<br></p>
  <ul>
  ...
  <p align="left">For getting in any of the above courses, contact Admin directly:<br>Email: admin@nyit.edu</p>
  <h4 align="left">Teachers: </h4>
  <p align="left">To join the experienced team of the faculty members of NSTUD, contact Admin :<br>Email: admin@nyit.edu</p><br><br>
  

   <h3>Contact Details:</h3>
   <p>
          <br>Manhattan, New York<br>
   </p>
   <p> 
   ...
   <p> You can also mail us at admin@nyit.edu</p>
